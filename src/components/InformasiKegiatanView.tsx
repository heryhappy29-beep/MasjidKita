      ...
      {!canManage && (
        <div className="bg-amber-50 border border-amber-200 text-amber-800 px-4 py-3 rounded-xl flex items-center justify-between shadow-xs">
          <div className="flex items-center space-x-2 text-xs sm:text-sm">
            ...
            <span>
              Anda mengakses sebagai <strong>Jama'ah / Publik (Daftar Berita & Jadwal)</strong>. Untuk memposting atau mengedit agenda & pengumuman, silakan login sebagai <strong>Sekretaris Masjid</strong> atau <strong>Super Admin</strong>.
            </span>
          </div>
          <button
            onClick={onOpenLogin}
